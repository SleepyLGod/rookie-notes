...
In practice, LevelDB starts flushing the current data block and appends it to the `sstable file` once it reaches `options.block_size`. This logic appears in **table/table_build.cc**:
...
Each record in a data block has the following layout: <img src="http://bean-li.github.io/assets/LevelDB/data_block_record.png" alt="img" style="zoom: 200%;" />
